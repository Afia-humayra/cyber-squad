...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/home/null/Desktop/homi/keytoken.json'
...
# Servo configuration
SERVO_SCRIPT = "/home/null/Desktop/homi/servo.py"  # Path to servo.py file
...
def show_fullscreen_image(image_path="test_image.png"):
    """Display an image in fullscreen as background - stays behind other windows"""
    ...
    def create_window():
        ...
        # Make window stay in background (below other windows)
        root.attributes('-fullscreen', True)
        root.attributes('-topmost', False)  # Don't stay on top
        root.lower()  # Send to back
        ...
        # Bind 'q' key to exit (optional - you may want to remove this)
        ...
        try:
            ...
            # Ensure window stays in background even after updates
            root.after(100, lambda: root.lower())
            
            print(f"Displaying background image: {image_path}")
            print("Background image will stay behind other windows")
    ...
    # Give the window time to initialize and go to background
    time.sleep(0.5)
...
def main():
    ...
    try:
        ...
        show_fullscreen_image("logo.jpeg")
    except Exception as e:
